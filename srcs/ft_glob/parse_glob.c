...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/20 05:43:44 by tapion            #+#    #+#             */
/*   Updated: 2021/04/20 05:43:47 by tapion           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	match_glob(t_dirent *rdir, t_parse_glob glob, t_data_glob **data, char *cmd)
{
	char	*str;
